...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p>
     <asp:Label ID="LblUsername" runat="server" ForeColor="#3399FF" Text="Email Address" Font-Bold="True" Font-Size="14pt"></asp:Label>
    </p>
<p>
    ...
    <p>
<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtUserId" ErrorMessage="User Email Required" Font-Bold="True" Font-Size="14pt" ForeColor="Red"></asp:RequiredFieldValidator>
    </p>
    <p>
